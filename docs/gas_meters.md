...
## Sensors
Specifically for BK-4, native reed switches switches ([Honeywell IN-ZXX](https://process.honeywell.com/us/en/site/elster-instromet-de/produkte/gasmessung/balgengaszahler/in-z61))
...
The sensor consists of the reed switch *only* &mdash; there is current limiting or debouncing electronics.
